...
class ControllerCatalogProduct extends Controller {
    ...
    public function preadd() {
        ...
        $data['allcats'] = $this->model_catalog_category->getCategories(array('filter_model' => '1', 'filter_type' => 'mm'));
        ...
        $this->response->setOutput($this->load->view('catalog/product_preform.tpl', $data));
    }
    ...
    protected function getForm() {
        ...
        $data['entry_unavail'] = $this->language->get('entry_unavail');
        ...
        if (isset($this->request->post['product_unavail'])) {
            ...
            $data['product_unavails'] = $this->model_catalog_product->getProductUnavailable($product_info['product_id']);
        } else {
        ...
        $data['agencies'] = $this->model_catalog_product->getAgencies();
...
// Images
        ...
        $images = $this->model_catalog_category->getCategoryImages($cat);
...
// Downloads
    ...
    public function cityautocomplete() {
        ...
        if (isset($this->request->get['filter_name'])) {
            ...
            $results = $this->model_catalog_product->getAllCities($filter_data);
