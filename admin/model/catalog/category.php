...
class ModelCatalogCategory extends Model {
    ...
    public function addCategory($data) {
        ...
        $result = "INSERT INTO " . DB_PREFIX . "category SET parent_id = '" . (int) $data['parent_id'] . "', `top` = '" . (isset($data['top']) ? (int) $data['top'] : 0) . "', `column` = '" . (int) $data['column'] . "', sort_order = '" . (int) $data['sort_order'] . "', status = '" . (int) $data['status'] . "', date_modified = NOW(), date_added = NOW(), type = '" . $data['type'] . "', model = '" . $this->db->escape($data['model']) . "',cat_id = '" . (int) $data['cat_id'] . "', subcat_id = '" . $data['subcat_id'] . "', daily = '" . $data['daily'] . "', weekly = '" . $data['weekly'] . "', weekend = '" . $data['weekend'] . "', mileage = '" . $data['mileage'] . "', delivery = '" . $data['delivery'] . "', airport = '" . $data['airport'] . "', security = '" . $data['security'] . "', description = '" . $data['description'] . "',  meta_tag_title = '" . $data['meta_tag_title'] . "', meta_tag_description = '" . $data['meta_tag_description'] . "', meta_keywords = '" . $data['meta_keywords'] . "' ";
    ...
    public function editCategory($category_id, $data) {  
        ...
        $this->db->query("UPDATE " . DB_PREFIX . "category SET parent_id = '" . (int) $data['parent_id'] . "', `top` = '" . (isset($data['top']) ? (int) $data['top'] : 0) . "', `column` = '" . (int) $data['column'] . "', sort_order = '" . (int) $data['sort_order'] . "', status = '" . (int) $data['status'] . "', date_modified = NOW(), model = '" . $this->db->escape($data['model']) . "',cat_id = '" . (int) $data['cat_id'] . "', subcat_id = '" . $data['subcat_id'] . "', daily = '" . $data['daily'] . "', weekly = '" . $data['weekly'] . "', weekend = '" . $data['weekend'] . "', mileage = '" . $data['mileage'] . "', delivery = '" . $data['delivery'] . "', airport = '" . $data['airport'] . "', security = '" . $data['security'] . "', description = '" . $data['description'] . "',  meta_tag_title = '" . $data['meta_tag_title'] . "', meta_tag_description = '" . $data['meta_tag_description'] . "', meta_keywords = '" . $data['meta_keywords'] . "' WHERE category_id = '" . (int) $category_id . "'");
