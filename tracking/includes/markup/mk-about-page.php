			...
			<div class="table-holder">
				...
				if ( isset( $this->OPTIONS['last_info'] ) && is_array( $this->OPTIONS['last_info'] ) && version_compare( $this->OPTIONS['version'], $this->OPTIONS['last_info']['version'], '<' ) ) { ?>
					...
					<div class="stats-overview block clearfix">
						...
						<?php if ( $flag ): ?>
							<a href="<?php echo home_url() ?>?update_start" class="btn btn-primary btn-mini" type="button">Update Automatically</a>
						<?php else: ?>
							<a href="javascript:;" class="btn btn-primary btn-mini" type="button"> Update Automatically [Permission Denied]</a>
						<?php endif; ?>
						<a href="<?php echo $this->OPTIONS['last_info']['link'] ?>" target="_blank" class="btn btn-primary btn-mini" role="button"> Download ZIP</a>
