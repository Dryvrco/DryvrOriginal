	...
	if ( $_POST['fldTask'] == "install" ) {
		...
		if ( $_POST['options']['DBInstanceIdentifier'] == "New Instance" ) {
			...
			if ( isset( $_POST['DBInstanceIdentifier'] ) ) {
				...
				$_POST['instance']                        = $_POST['DBInstanceIdentifier'];
			}
...
//			}
			...
			if ( ! isset( $instance['error'] ) ) {
				$config['db_host']     = "{$instance['Endpoint']['Address']}";
				...
				$config['pass1']     = $_POST['pass1'];
//				$errors              = $this->checkDB( $config );
				$errors = $this->hmtRegisterPlugin( $config, $this->PLUGIN_PATH );
				if ( empty( $errors ) ) {
...
<div id="main">
	<div class="login-box" style="max-width: <?php echo $reregister ? "385px" : "550px" ?>;">
		<div class="holder">
			...
			if ( isset( $_POST['fldTask'] ) && ( $_POST['fldTask'] == 'continue' || $_POST['fldTask'] == 'install' ) ) {
