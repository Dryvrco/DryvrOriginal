...
$_['entry_processing_status']          = 'Processing Booking Status';
$_['entry_complete_status']            = 'Complete Booking Status';
$_['entry_order_mail']                 = 'New Booking Alert Mail';
...
$_['entry_fraud_status']               = 'MaxMind Fraud Booking Status';
...
$_['help_open']                        = 'Fill in your Market Place\'s opening times.';
...
$_['help_currency_auto']               = 'Set your Market Place to automatically update currencies daily.';
...
$_['help_limit_admin']   	           = 'Determines how many admin items are shown per page (Bookings, customers, etc).';
$_['help_product_count']               = 'Show the number of products inside the subcategories in the Market Placefront header category menu. Be warned, this will cause an extreme performance hit for Market Places with a lot of subcategories!';
...
$_['help_review_mail']                 = 'Send an email to the Market Place owner when a new review is created.';
...
$_['help_tax_default']                 = 'Use the Market Place address to calculate taxes if no one is logged in. You can choose to use the Market Place address for the customer\'s shipping or payment address.';
...
$_['help_account_mail']                = 'Send an email to the Market Place owner when a new account is registered.';
...
$_['help_processing_status']           = 'Set the Booking status the customer\'s Booking must reach before the Booking starts stock subtraction and coupon, voucher and rewards redemption.';
$_['help_complete_status']             = 'Set the Booking status the customer\'s Booking must reach before they are allowed to access their downloadable products and gift vouchers.';
$_['help_order_mail']                  = 'Send an email to the Market Place owner when a new Booking is created.';
...
$_['help_affiliate_auto']              = 'Automatically add commission when each Booking reaches the complete status.';
...
$_['help_affiliate_mail']              = 'Send an email to the Market Place owner when a new affiliate is registered.';
...
$_['help_ftp_root']                    = 'The directory your OpenCart installation is Market Placed in. Normally \'public_html/\'.';
...
$_['help_mail_alert']                  = 'Any additional emails you want to receive the alert email, in addition to the main Market Place email. (comma separated).';
...
$_['help_fraud_score']                 = 'The higher the score the more likely the Booking is fraudulent. Set a score between 0 - 100.';
$_['help_fraud_status']                = 'Bookings over your set score will be assigned this Booking status and will not be allowed to reach the complete status automatically.';
...
$_['help_shared']                      = 'Try to share the session cookie between Market Places so the cart can be passed between different domains.';
...
$_['help_maintenance']                 = 'Prevents customers from browsing your Market Place. They will instead see a maintenance message. If logged in as admin, you will see the Market Place as normal.';
...
$_['help_encryption']                  = 'Please provide a secret key that will be used to encrypt private information when processing Bookings.';
...
$_['error_processing_status']          = 'You must choose at least 1 Booking process status';
$_['error_complete_status']            = 'You must choose at least 1 Booking complete status';
