<?php
// Heading
$_['heading_title']                    = 'Market Places';

// Text
$_['text_settings']                    = 'Settings';
$_['text_success']                     = 'Success: You have modified Market Places!';
$_['text_list']                        = 'Market Place List';
$_['text_add']                         = 'Add Market Place';
$_['text_edit']                        = 'Edit Market Place';
$_['text_items']                       = 'Items';
$_['text_tax']                         = 'Taxes';
...
// Column
$_['column_name']                      = 'Market Place Name';
$_['column_url']	                   = 'Market Place URL';
$_['column_action']                    = 'Action';

// Entry
$_['entry_url']                        = 'Market Place URL';
$_['entry_ssl']                        = 'SSL URL';
$_['entry_name']                       = 'Market Place Name';
$_['entry_owner']                      = 'Market Place Owner';
...
$_['entry_location']                   = 'Market Place Location';
...
$_['entry_tax_default']                = 'Use Market Place Tax Address';
...
$_['entry_image_location']             = 'Market Place Image Size';
$_['entry_width']                      = 'Width';
$_['entry_height']                     = 'Height';
$_['entry_secure']                     = 'Use SSL';

// Help
$_['help_url']                         = 'Include the full URL to your Market Place. Make sure to add \'/\' at the end. Example: http://www.yourdomain.com/path/<br /><br />Don\'t use directories to create a new Market Place. You should always point another domain or sub domain to your hosting.';
$_['help_ssl']                         = 'SSL URL to your Market Place. Make sure to add \'/\' at the end. Example: http://www.yourdomain.com/path/<br /><br />Don\'t use directories to create a new Market Place. You should always point another domain or sub domain to your hosting.';
$_['help_geocode']                     = 'Please enter your Market Place location geocode manually.';
$_['help_open']                        = 'Fill in your Market Places opening times.';
$_['help_comment']                     = 'This field is for any special notes you would like to tell the customer i.e. Market Place does not accept cheques.';
$_['help_location']                    = 'The different Market Place locations you have that you want displayed on the contact us form.';
...
$_['help_tax_default']                 = 'Use the Market Place address to calculate taxes if no one is logged in. You can choose to use the Market Place address for the customers shipping or payment address.';
...
$_['help_customer_group_display']      = 'Display customer groups that new customers can select to use such as wholeIncome and business when signing up.';
...
$_['help_order_status']                = 'Set the default Booking status when an Booking is processed.';
$_['help_stock_display']               = 'Display stock quantity on the product page.';
$_['help_stock_checkout']              = 'Allow customers to still checkout if the products they are Bookinging are not in stock.';
...
$_['error_permission']                 = 'Warning: You do not have permission to modify Market Places!';
$_['error_name']                       = 'Market Place Name must be between 3 and 32 characters!';
$_['error_owner']                      = 'Market Place Owner must be between 3 and 64 characters!';
$_['error_address']                    = 'Market Place Address must be between 10 and 256 characters!';
$_['error_email']                      = 'E-Mail Address does not appear to be valid!';
$_['error_telephone']                  = 'Telephone must be between 3 and 32 characters!';
$_['error_url']                        = 'Market Place URL required!';
...
$_['error_image_location']             = 'Market Place Image Size dimensions required!';
$_['error_default']                    = 'Warning: You can not delete your default store!';
$_['error_store']                      = 'Warning: This Store cannot be deleted as it is currently assigned to %s Bookings!';