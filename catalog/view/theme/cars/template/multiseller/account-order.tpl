  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?> ms-account-order"><?php echo $content_top; ?>
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="pull-right"><a href="<?php echo $link_back; ?>" class="requestBtn"><span><?php echo $button_back; ?></span></a></div>
        </div>
      </div>
        ...
        <table class="list table table-bordered table-hover" id="list-orders">
          <thead>
            <tr>
              ...
              <td class="medium"><?php echo $ms_account_orders_products; ?></td>
              <td class="medium">Reservation Time</td>
	...
	$(function() {
		$('#list-orders').dataTable( {
			...
			"aoColumns": [
				...
				{ "mData": "booking_time", "bSortable": false  },
				/*{ "mData": "date_created" },*/
				/*{ "mData": "total_amount" },*/
				{ "mData": "view_order" }
			],
