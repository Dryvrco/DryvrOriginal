      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-image" data-toggle="tab">Extra Images</a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <!--<div class="form-group">
                ...
                <div class="col-sm-10">
                  	<input name="city" value="<?php echo $city; ?>" type="text" class="form-control" placeholder="City" />
          ...
          <div class="form-group" style="display:none">
            ...
            <?php if ($area_id){ ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_agency; ?></label>
                <div class="col-sm-10">
                  <select class="form-control" name="agency_id">
                    <option value="">- Select Agency -</option>
                    <?php mkdd($agencies, $agency_id); ?>
                  </select>
                </div>
              </div>
              <div class="form-group">
