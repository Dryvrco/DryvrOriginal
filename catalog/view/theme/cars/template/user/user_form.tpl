            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="user_group_id" id="input-user-group" class="form-control">
                  ...
                  <?php if ($user_group['customer_group_id'] == $user_group_id) { ?>
                  <option value="<?php echo $user_group['customer_group_id']; ?>" selected="selected"><?php echo $user_group['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $user_group['customer_group_id']; ?>"><?php echo $user_group['name']; ?></option>
                  <?php } ?>
                  <?php } ?>
                </select>
              </div>
