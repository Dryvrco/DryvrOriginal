				...
				if ($product_query->num_rows) {
					...
					$this->data[$key] = array(
						...
						'minimum'         => $product_query->row['minimum'],
                                                'daily'           => $product_query->row['daily'],
						'subtract'        => $product_query->row['subtract'],
						'stock'           => $stock,
						'price'           => (calculaterate($this->session->data['booking_hours'], $product_query->row['daily'], $product_query->row['weekly'], $product_query->row['monthly']) + $option_price),
						'total'           => (calculaterate($this->session->data['booking_hours'], $product_query->row['daily'], $product_query->row['weekly'], $product_query->row['monthly']) + $option_price) * $quantity,
