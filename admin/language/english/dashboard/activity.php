...
$_['text_customer_order_account']  = '<a href="customer_id=%d">%s</a> added a <a href="order_id=%d">new Booking</a>.';
$_['text_customer_order_guest']    = '%s created a <a href="order_id=%d">new Booking</a>.';
