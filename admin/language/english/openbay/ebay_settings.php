...
$_['text_import_description']		= 'Customise the status of an Booking during different stages. You cannot use a status on an eBay Booking that does not exist in this list.';
...
$_['text_notifications']			= 'Control when customers receive notifications from the application. Enabling update emails can improve your DSR ratings as the user will get updates about their Booking.';
...
$_['entry_created_hours']			= 'New Booking age limit';
$_['entry_developer_locks']			= 'Remove Booking locks?';
...
$_['entry_create_date']				= 'Created date for new Bookings';
$_['entry_notify_order_update']		= 'Booking updates';
$_['entry_notify_buyer']			= 'New Booking - buyer';
$_['entry_notify_admin']			= 'New Booking - admin';
$_['entry_import_pending']			= 'Import unpaid Bookings:';
...
$_['help_created_hours']   			= 'Bookings are new when younger than this limit (in hours). Default is 72';
...
$_['help_tax']             			= 'Used when you import items or Bookings';
...
$_['help_create_date']         		= 'Choose which created time will appear on an Booking when it is imported';
$_['help_timezone_offset']     		= 'Based on hours. 0 is GMT timezone. Only works if eBay time is used for Booking creation.';
$_['help_notify_admin']   			= 'Notify the store admin with the default new Booking email';
$_['help_notify_order_update']		= 'This is for automated updates, for example if you update an Booking in eBay and the new status is updated in your store automatically.';
$_['help_notify_buyer']        		= 'Notify the user with the default new Booking email';
