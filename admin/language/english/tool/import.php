<?php
// Heading
$_['heading_title']    = 'Import Excel file';
$_['button_import']    = 'Import file  ';
$_['entry_import']    = 'Import xls File <span class="help">Please Import Same format if you have not format please download <a href="'.HTTP_CATALOG.'image/data/csv template.xls">From here</a> </span>';
