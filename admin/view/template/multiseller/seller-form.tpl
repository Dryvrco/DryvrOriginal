    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form id="ms-sellerinfo" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div id="sellerinfo_avatar_files">
                    	<?php if ($seller['avatar']['thumb']=='') { $seller['avatar']['thumb']=$placeholder; } ?>
                        <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $seller['avatar']['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                 		
                        <input type="hidden" name="seller[avatar_name]" value="<?php echo $seller['avatar']['name']; ?>" id="input-image" />
            ...
            <div class="form-group">   
            <label class="col-sm-2 control-label">Featured<!--<?php echo $ms_featured; ?>--></label>
            <div class="col-sm-10">
            <?php if($seller_featured == '1') { ?>
            <input type="checkbox" name="seller[featured]" value="1" checked="checked" class="form-control" /> 
             <?php } else { ?>
             <input type="checkbox" name="seller[featured]" value="1" class="form-control" />  
             <?php } ?>
            </div>
            </div>
