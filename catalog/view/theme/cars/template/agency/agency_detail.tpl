         ...
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-sm-8">
                  <div class="agncy-topabar">
                     ...
                     <div class="col-sm-4 pull-right">
                        <ul role="tablist" class="nav nav-pills pull-right">
                           <li class="active mrg-btm0" role="presentation"> <strong><?php echo $cars_available; ?></strong>&nbsp;&nbsp;<span class="badge drkbtn"><?php echo $agency_car_total; ?></span> </li>
                        </ul>
                     </div>
                  </div>
                  <div>
                  ...
                  <div class="clear"></div>
                  <?php if ($nearbyareas!=''){ ?>
                  <div class="agncy-topabar nrby-loc"><i class="fa fa-map-marker"></i> Nearby Location </div>
                  <div class="row">
                  	<?php foreach ($nearbyareas as $location){ ?>
                    	<?php if ($location != ''){ ?>
                     	<div class="col-sm-4 car-ftr"><?php echo $location ?></div>
                     	<?php } ?>
                     <?php } ?>
                  </div>
                  <?php } ?>
               ...
               <div class="product-layout product-list">
                  <div class="agncy-lstg">
                     ...
                     <div class="col-sm-9 desc">
                        <h1 class="itm-nam tog"> <a class="pull-left" href="<?php echo $agency_car['href']; ?>"><?php echo $agency_car['name']; ?></a> </h1>
                        <div class="dscrp"><?php echo $agency_car['description']; ?></div>
                        <div class=" pricing tog">
                           <div class="row">
                              <div class="col-sm-4"> <span>Daily</span>
                                 <p><?php echo $agency_car['daily']; ?></p>
                              </div>
                              <div class="col-sm-4"><span>Weekly</span>
                                 <p><?php echo $agency_car['weekly']; ?></p>
                              </div>
                              <div class="col-sm-4"><span>Monthly</span>
                                 <p><?php echo $agency_car['monthly']; ?></p>
                              </div>
                           </div>
                           <div class="tog"> <a href="<?php echo $agency_car['href']; ?>" class="requestBtn">View Details</a> </div>
                        </div>
                     </div>
                  </div>
               </div>
