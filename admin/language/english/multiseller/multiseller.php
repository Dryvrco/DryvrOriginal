...
$_['ms_error_product_publish'] = 'Failed to publish some Vehicles: Agent account not active.';
$_['ms_success_installed'] = 'Extension successfully installed';
$_['ms_success_product_status'] = 'Successfully changed Vehicle status.';
...
$_['text_seller_select'] = 'Agent select';
...
$_['ms_none'] = 'None';
$_['ms_seller'] = 'Agent';
$_['ms_all_sellers'] = 'All Agents';
$_['ms_amount'] = 'Amount';
$_['ms_product'] = 'Vehicle';
...
$_['ms_menu_sellers'] = 'Agents';
$_['ms_menu_seller_groups'] = 'Agent groups';
$_['ms_menu_attributes'] = 'Attributes';
$_['ms_menu_products'] = 'Vehicles';
...
$_['ms_config_seller_validation'] = 'Agent validation';
$_['ms_config_seller_validation_note'] = 'Agent validation';
...
$_['ms_config_product_validation'] = 'Vehicle validation';
$_['ms_config_product_validation_note'] = 'Vehicle validation';
$_['ms_config_product_validation_none'] = 'No validation';
$_['ms_config_product_validation_approval'] = 'Manual approval';

$_['ms_config_allow_inactive_seller_products'] = 'Allow inactive Agents to list Vehicles';
$_['ms_config_allow_inactive_seller_products_note'] = 'Allows inactive Agents to list new Vehicles, which will be inactive. After approval of such Agent all his Vehicles will become active at once.';

$_['ms_config_disable_product_after_quantity_depleted'] = 'Disable Vehicle after quantity depletes';
$_['ms_config_disable_product_after_quantity_depleted_note'] = 'The Vehicle will be disabled after it is sold out (quantity is 0)';

$_['ms_config_allow_relisting'] = 'Allow re-listing disabled Vehicles';
$_['ms_config_allow_relisting_note'] = 'Agents will be able to re-list the Vehicles, which have been disabled (useful if you use Vehicle limitation by period or quantity in combination with listing fees)';

$_['ms_config_enable_banner'] = 'Enable Agent banners';
$_['ms_config_enable_banner_note'] = 'Allow Agents to upload a banner that will be displayed on their profile page';

$_['ms_config_enable_one_page_seller_registration'] = 'One-page registration';
$_['ms_config_enable_one_page_seller_registration_note'] = 'Enable Agent one-page registration';

$_['ms_config_minmax_product_price'] = 'Minimum and maximum Vehicle price';
$_['ms_config_minimum_product_price'] = 'Min';
$_['ms_config_maximum_product_price'] = 'Max';
$_['ms_config_minmax_product_price_note'] = 'Minimum and maximum Vehicle price (0 for no limits)';

$_['ms_config_allowed_image_types'] = 'Allowed image extensions';
$_['ms_config_allowed_image_types_note'] = 'Allowed image extensions';

$_['ms_config_images_limits'] = 'Vehicle image limits';
$_['ms_config_images_limits_note'] = 'Minimum and maximum number of images (incl. thumbnail) required/allowed for Vehicles (0 = no limit)';

$_['ms_config_downloads_limits'] = 'Vehicle download limits';
$_['ms_config_downloads_limits_note'] = 'Minimum and maximum number of downloads required/allowed for Vehicles (0 = no limit)';
...
$_['ms_config_credit_order_statuses_note'] = 'Agent balance will be funded for orders with fund statuses';

$_['ms_config_debit_order_statuses'] = 'Charge statuses';
$_['ms_config_debit_order_statuses_note'] = 'Agent balance will be charged for orders with charge statuses';

$_['ms_config_display_order_statuses'] = 'Display order statuses';
$_['ms_config_display_order_statuses_note'] = 'Order statuses that aren\'t selected here will not be visible to Agents';
...
$_['ms_config_allow_partial_withdrawal_note'] = 'Allow Agents to request partial payouts';

$_['ms_config_allow_withdrawal_requests'] = 'Allow payout requests';
$_['ms_config_allow_withdrawal_requests_note'] = 'Allow Agents to request earnings';
...
$_['ms_config_allow_free_products'] = 'Allow free Vehicles';
$_['ms_config_allow_free_products_note'] = 'Allow Agents to add free Vehicles';

$_['ms_config_allow_multiple_categories'] = 'Allow multiple categories';
$_['ms_config_allow_multiple_categories_note'] = 'Allow Agents to add Vehicles to multiple categories';

$_['ms_config_additional_category_restrictions'] = 'Bulk disallow categories';
$_['ms_config_additional_category_restrictions_note'] = '<u>Disallow</u> Agents to list Vehicles in specific categories';
...
$_['ms_config_restrict_categories_note'] = '<u>Disallow</u> Agents to list Vehicles in these categories';

$_['ms_config_product_included_fields'] = 'Include fields for Vehicles';
$_['ms_config_product_included_fields_note'] = 'Fields to be added in the Vehicle form';

$_['ms_config_provide_buyerinfo'] = 'Mail buyer information';
$_['ms_config_provide_buyerinfo_note'] = 'Include buyer address in the Vehicle purchased email';

$_['ms_config_enable_shipping'] = 'Enable shipping';
$_['ms_config_enable_shipping_note'] = 'New Vehicles will be created to require shipping';

$_['ms_config_enable_quantities'] = 'Enable quantities';
$_['ms_config_enable_quantities_note'] = 'Allow Agents to specify quantities for Vehicles';

$_['ms_config_seller_terms_page'] = 'Agent account terms';
$_['ms_config_seller_terms_page_note'] = 'Agents have to agree to the terms when creating a Agent account.';

$_['ms_config_allow_specials'] = 'Allow special prices';
$_['ms_config_allow_specials_note'] = 'Allow Agents to define special prices';

$_['ms_config_allow_discounts'] = 'Allow quantity discounts';
$_['ms_config_allow_discounts_note'] = 'Allow Agents to define quantity discounts';
 
$_['ms_config_withdrawal_waiting_period'] = 'Payout waiting period';
$_['ms_config_withdrawal_waiting_period_note'] = 'Agent balance entries newer than this value will not be available for payout requests';

$_['ms_config_graphical_sellermenu'] = 'Graphical Agent menu';
$_['ms_config_graphical_sellermenu_note'] = 'Graphical Agent menu';

$_['ms_config_productform'] = 'Vehicle form';
...
$_['ms_config_enable_rte_note'] = 'Enable Summernote Rich Text Editor for Vehicle and Agent description fields.';
...
$_['ms_config_seller_avatar_image_size_seller_profile'] = 'Agent profile';
$_['ms_config_seller_avatar_image_size_seller_list'] = 'Agent list';
$_['ms_config_seller_avatar_image_size_product_page'] = 'Vehicle page';
$_['ms_config_seller_avatar_image_size_seller_dashboard'] = 'Agent dashboard';
$_['ms_config_seller_banner_size'] = 'Agent banner size';

$_['ms_config_image_preview_size'] = 'Image preview size';
$_['ms_config_image_preview_size_seller_avatar'] = 'Agent avatar';
$_['ms_config_image_preview_size_product_image'] = 'Vehicle image';

$_['ms_config_product_image_size'] = 'Vehicle image size';
$_['ms_config_product_image_size_seller_profile'] = 'Agent profile';
$_['ms_config_product_image_size_seller_products_list'] = 'Catalog Vehicles';
$_['ms_config_product_image_size_seller_products_list_account'] = 'Account Vehicles';
...
$_['ms_config_seo'] = 'SEO';
$_['ms_config_enable_seo_urls_seller'] = 'Generate SEO URLs for new Agents';
$_['ms_config_enable_seo_urls_seller_note'] = 'This option will generate SEO-friendly URLs for new Agents. SEO URLs need to be enabled in OpenCart to use this.';
$_['ms_config_enable_seo_urls_product'] = 'Generate SEO URLs for new Vehicles (experimental)';
$_['ms_config_enable_seo_urls_product_note'] = 'This option will generate SEO-friendly URLs for new Vehicle. SEO URLs need to be enabled in OpenCart to use this. Experimental, especially for non-English stores.';
$_['ms_config_enable_update_seo_urls'] = 'Enable SEO URLs generation for updated Vehicles';
$_['ms_config_enable_update_seo_urls_note'] = 'This setting enables new SEO URLs generation, when existing Vehicles are updated.';
...
$_['ms_config_sellers_slug'] = 'Agents SEO keyword';
$_['ms_config_sellers_slug_note'] = 'Agents list SEO keyword (will work only if SEO is enabled)';

$_['ms_config_attributes'] = 'Attributes';
$_['ms_config_attribute_display'] = 'Attribute display';
$_['ms_config_attribute_display_note'] = 'Controls the way how attributes are displayed on the Vehicle page';
...
$_['ms_config_enable_private_messaging'] = 'Allow customers to contact Agents';
$_['ms_config_enable_private_messaging_note'] = 'Enables or disables the Agent contact dialog';

$_['ms_config_hide_customer_email'] = 'Hide customer email address';
$_['ms_config_hide_customer_email_note'] = 'Hides customer email address in the Agent dashboard and in orders list';
$_['ms_config_hide_email_in_email'] = 'Hide email addresses in emails';
$_['ms_config_hide_email_in_email_note'] = 'Hides customer and Agent email addresses in the emails sent by MultiMerch';

$_['ms_config_seller'] = 'Agents';

// Change Seller Nickname
$_['ms_config_seller_change_nickname'] = 'Allow nickname change';
$_['ms_config_seller_change_nickname_note'] = 'Allow Agents to change nickname/shop name';

// Seller Nickname Rules
$_['ms_config_nickname_rules'] = 'Agent nickname rules';
$_['ms_config_nickname_rules_note'] = 'Character sets allowed in Agent nicknames';
...
// Agent Avatars
$_['ms_config_avatars_for_sellers'] = 'Avatars for Agents';
$_['ms_config_avatars_for_sellers_note'] = 'Define the way Agent avatars work';
$_['ms_config_avatars_manually'] = 'Uploaded manually by Agent';
$_['ms_config_avatars_both'] = 'Both uploaded by Agent and pre-defined';
$_['ms_config_avatars_predefined'] = 'Only pre-defined';

$_['ms_config_other'] = 'Other';
$_['ms_config_hide_sellers_product_count'] = 'Hide count of Agents and Vehicles in the header';
$_['ms_config_hide_sellers_product_count_note'] = 'Hides line, which contains count of Agents and Vehicles in the header';

// Seller - List
$_['ms_catalog_sellers_heading'] = 'Agents';
$_['ms_catalog_sellers_breadcrumbs'] = 'Agents';
$_['ms_catalog_sellers_newseller'] = 'New Agent';
$_['ms_catalog_sellers_create'] = 'Create new Agent';

$_['ms_catalog_sellers_total_balance'] = 'Total amount on all balances: <b>%s</b> (active Agents: <b>%s</b>)';
$_['ms_catalog_sellers_email'] = 'Email';
$_['ms_catalog_sellers_total_products'] = 'Vehicles';
...
$_['ms_seller_change'] = 'Change Agent';
...
$_['ms_catalog_sellerinfo_heading'] = 'Agent';
$_['ms_catalog_sellerinfo_seller_data'] = 'Agent data';
...
$_['ms_catalog_sellerinfo_company'] = 'Street Adress';
...
$_['ms_catalog_sellerinfo_sellergroup'] = 'Agent group';
...
$_['ms_catalog_sellerinfo_notify'] = 'Notify Agent via email';
$_['ms_catalog_sellerinfo_product_validation'] = 'Vehicle validation';
$_['ms_catalog_sellerinfo_product_validation_note'] = 'Vehicle validation for this Agent';
...
// Catalog - Vehicles
$_['ms_catalog_products_heading'] = 'Vehicles';
$_['ms_catalog_products_breadcrumbs'] = 'Vehicles';
$_['ms_catalog_products_notify_sellers'] = 'Notify Agents';
$_['ms_catalog_products_bulk'] = '--Bulk status change--';
$_['ms_catalog_products_noseller'] = '--No Agent--';
...
$_['ms_catalog_seller_groups_heading'] = 'Agent groups';
$_['ms_catalog_seller_groups_breadcrumbs'] = 'Agent Groups';

$_['ms_seller_groups_column_id'] = 'ID';
$_['ms_seller_groups_column_name'] = 'Name';
$_['ms_seller_groups_column_action'] = 'Actions';

$_['ms_catalog_insert_seller_group_heading'] = 'New Agent Group';
$_['ms_catalog_edit_seller_group_heading'] = 'Edit Agent Group';

$_['ms_product_period'] = 'Vehicle listing period in days (0 for unlimited)';
$_['ms_product_quantity'] = 'Vehicle quantity (0 for no limit)';

$_['ms_error_seller_group_name'] = 'Error: Name must be between 3 and 32 symbols long';
$_['ms_error_seller_group_default'] = 'Error: Default Agent group can not be deleted!';
$_['ms_success_seller_group_created'] = 'Agent group created';
$_['ms_success_seller_group_updated'] = 'Agent group updated';
...
$_['ms_error_payment_fromto'] = 'Only store to Agent and Agent to store payments are supported.';
$_['ms_error_payment_fromstore'] = 'Outgoing payments (store to Agent) can only be of types Payout or Payout request';
$_['ms_error_payment_tostore'] = 'Incoming payments (Agent to store) can not be of types Payout or Payout request';
$_['ms_error_payment_amount'] = 'Please specify a valid payment amount';
$_['ms_error_payment_norequests'] = 'Error: no valid payouts to process. Please make sure the Agents have enough funds and valid PayPal addresses specified';
...
$_['ms_error_transaction_fromto'] = 'Please specify at least the source or the destination Agent';
...
$_['ms_attribute_tab_display'] = 'Display as Vehicle tab';
...
$_['ms_mail_subject_seller_account_modified'] = 'Agent account modified';
$_['ms_mail_seller_account_modified'] = <<<EOT
Your Agent account at %s has been modified by the administrator.

Account status: %s
EOT;

$_['ms_mail_subject_product_modified'] = 'Vehicle modified';
$_['ms_mail_product_modified'] = <<<EOT
Your Vehicle %s at %s has been modified by the administrator.
...
Your Vehicle(s) have been purchased from %s.
...
$_['ms_payment_method_balance'] = 'Agent balance';
