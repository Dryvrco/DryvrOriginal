    ...
    <tbody>
      <tr>
        ...
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_email; ?></b> <?php echo $email; ?><br />
          ...
          <b>Start Time:</b> <?php echo $res_start; ?><br />
          <b>End Time:</b> <?php echo $res_end; ?><br /></td>
      </tr>
      
      <tr>
      	<?php if ($driver_license!=''){ ?>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b>Driver Licence:</b> <?php echo $driver_license; ?><br />
          <b>Expiry Date:</b> <?php echo sprintf("%02d", $dl_expiry_mm).'/'.$dl_expiry_yy; ?><br /></td>
          <?php } ?>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b>Insurance Company Name:</b> <?php echo $ins_company_name; ?><br />
          <b>Agent Name:</b> <?php echo $ins_agent_name; ?><br />
          <b>Policy Number:</b> <?php echo $ins_policy_number; ?><br />
          <b>Expiry Date:</b> <?php echo sprintf("%02d", $ins_expiry_mm).'/'.$ins_expiry_yy; ?><br /></td>
      </tr>
    </tbody>
  </table>  
  <?php if ($comment) { ?>
