...
class ControllerUserUserPermission extends Controller {
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('user/user_permission' . $url));
        }
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('user/user_permission' . $url, 'SSL'));
        }
    ...
    protected function getList() {
        ...
        $data['add'] = $this->url->link('user/user_permission/add' . $url, 'SSL');
        $data['delete'] = $this->url->link('user/user_permission/delete' . $url, 'SSL');
        ...
        foreach ($results as $result) {
            $data['user_groups'][] = array(
                'user_group_id' => $result['customer_group_id'],
                'name' => $result['name'],
                'edit' => $this->url->link('user/user_permission/edit&user_group_id=' . $result['customer_group_id'] . $url, 'SSL')
            );
        }
        ...
        $data['sort_name'] = $this->url->link('user/user_permission&sort=name' . $url, 'SSL');
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/user/user_group_list.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/user/user_group_list.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/catalog/user/user_group_list.tpl', $data));
        }
    }
    ...
    protected function getForm() {
        ...
        if (!isset($this->request->get['user_group_id'])) {
            $data['action'] = $this->url->link('user/user_permission/add' . $url, 'SSL');
        } else {
            $data['action'] = $this->url->link('user/user_permission/edit&user_group_id=' . $this->request->get['user_group_id'] . $url, 'SSL');
        }

        $data['cancel'] = $this->url->link('user/user_permission' . $url, 'SSL');
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/user/user_group_form.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/user/user_group_form.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/catalog/user/user_group_form.tpl', $data));
        }
    }
