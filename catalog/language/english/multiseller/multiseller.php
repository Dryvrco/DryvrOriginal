...
// * Global *
// **********
$_['ms_viewinstore'] = 'View on site';
$_['ms_view'] = 'View';
$_['ms_view_modify'] = 'View / Modify';
$_['ms_publish'] = 'Activate';
$_['ms_unpublish'] = 'Deactivate';
$_['ms_edit'] = 'Edit';
$_['ms_clone'] = 'Clone';
$_['ms_relist'] = 'Relist';
$_['ms_rate'] = 'Rate';
$_['ms_download'] = 'Download';
$_['ms_create_product'] = 'Add New Vehicle';
$_['ms_delete'] = 'Delete';
$_['ms_reviews'] = 'Reviews';
$_['ms_update'] = 'Update';
$_['ms_type'] = 'Type';
$_['ms_amount'] = 'Amount';
$_['ms_status'] = 'Status';
...
$_['ms_none'] = 'None';
$_['ms_view_reservations'] = 'View Reservations';
...
$_['ms_transaction_listing'] = 'Vehicle listing: %s (%s)';
...
$_['ms_text_welcome'] = '<a href="%s">Login</a> | <a href="%s">Create an account</a> | <a href="%s">Create a Agency account</a>.';
$_['ms_button_register_seller'] = 'Register as a Agency';
$_['ms_register_seller_account'] = 'Register a Agency account';
...
$_['ms_mail_subject_seller_account_created'] = 'Agency account created';
...
$_['ms_mail_subject_seller_account_awaiting_moderation'] = 'Agency account awaiting moderation';
...
$_['ms_mail_subject_product_awaiting_moderation'] = 'Vehicle awaiting moderation';
...
$_['ms_mail_subject_remind_listing'] = 'Vehicle listing has finished';
$_['ms_mail_seller_remind_listing'] = <<<EOT
Your product's %s listing has finished. Go to your account Agency area if you would like to re-list the product.
EOT;

// *********
// * Admin *
// *********
$_['ms_mail_admin_subject_seller_account_created'] = 'New Agency account created';
...
You can process it in the Multiseller - Agencies section in back office.
EOT;
...
You can process it in the Multiseller - Vehicles section in back office.
EOT;

$_['ms_mail_admin_subject_edit_product_awaiting_moderation'] = 'Vehicle edited and awaiting moderation';
$_['ms_mail_admin_edit_product_awaiting_moderation'] = <<<EOT
Vehicle %s at %s has been edited and is awaiting moderation.
...
// Success
$_['ms_success_product_published'] = 'Vehicle published';
$_['ms_success_product_unpublished'] = 'Vehicle unpublished';
$_['ms_success_product_created'] = 'Vehicle created';
$_['ms_success_product_updated'] = 'Vehicle updated';
$_['ms_success_product_deleted'] = 'Vehicle deleted';
...
$_['ms_error_product_name_empty'] = 'Vehicle name cannot be empty';
$_['ms_error_product_name_length'] = 'Vehicle name should be between %s and %s characters';
$_['ms_error_product_description_empty'] = 'Vehicle description cannot be empty';
$_['ms_error_product_description_length'] = 'Vehicle description should be between %s and %s characters';
...
$_['ms_error_product_model_empty'] = 'Vehicle model cannot be empty';
$_['ms_error_product_model_length'] = 'Vehicle model should be between %s and %s characters';
...
$_['ms_error_seller_product'] = 'You can\'t book your own car.';

// Account - General
$_['ms_account_unread_pm'] = 'You have unread private message';
$_['ms_account_unread_pms'] = 'You have %s unread private messages';
$_['ms_account_register_new'] = 'New Agency';
$_['ms_account_register_seller'] = 'Register agency account';
$_['ms_account_register_seller_note'] = 'Create a agency account and start selling your products in our store!';
$_['ms_account_register_details'] = 'Step 1: Your Details';
$_['ms_account_register_seller_success_heading'] = 'Your Agency Account Has Been Created!';
...
$_['ms_seller'] = 'Agency';
$_['ms_seller_forseller'] = 'For Agency';
$_['ms_account_dashboard'] = 'Dashboard';
$_['ms_account_seller_account'] = 'Agency Account';
$_['ms_account_customer_account'] = 'Customer Account';
$_['ms_account_sellerinfo'] = 'Agency profile';
$_['ms_account_sellerinfo_new'] = 'New seller account';
$_['ms_account_newproduct'] = 'New Vehicle';
$_['ms_account_products'] = 'My Vehicles';
$_['ms_account_transactions'] = 'Transactions';
$_['ms_account_orders'] = 'Bookings';
$_['ms_account_withdraw'] = 'Request payout';
$_['ms_account_stats'] = 'Statistics';
$_['ms_total_bookings'] = 'Total Bookings';
$_['ms_total_income'] = 'Total Income';
$_['ms_total_vehicles'] = 'Total Vehicles';
$_['ms_bank_account'] = 'Bank Accounts';
$_['ms_staff'] = 'Staff';
$_['ms_staff_groups'] = 'Staff Groups'; 
$_['ms_reports'] = 'Reports';
$_['ms_view_more'] = 'View more...'; 

// Account - New product
$_['ms_account_newproduct_heading'] = 'New Vehicle';
$_['ms_account_newproduct_breadcrumbs'] = 'New Vehicle';
//General Tab
...
$_['ms_account_product_price'] = 'Rate';
$_['ms_account_product_daily_price'] = 'Daily Rate';
$_['ms_account_product_weekly_price'] = 'Weekly Rate';
$_['ms_account_product_weekend_price'] = 'Weekend Rate';
...
$_['ms_account_product_listing_itemname'] = 'Vehicle listing fee at %s';
...
$_['ms_account_product_upc_note'] = 'Universal Vehicle Code';
...
$_['ms_account_editproduct_heading'] = 'Edit Vehicle';
$_['ms_account_editproduct_breadcrumbs'] = 'Edit Vehicle';

// Account - Clone product
$_['ms_account_cloneproduct_heading'] = 'Clone Vehicle';
$_['ms_account_cloneproduct_breadcrumbs'] = 'Clone Vehicle';

// Account - Relist product
$_['ms_account_relist_product_heading'] = 'Relist Vehicle';
$_['ms_account_relist_product_breadcrumbs'] = 'Relist Vehicle';

// Account - Seller
$_['ms_account_sellerinfo_heading'] = 'Agency Profile';
$_['ms_account_sellerinfo_breadcrumbs'] = 'Agency Profile';
...
$_['ms_account_sellerinfo_company'] = 'Company Name';
...
$_['ms_account_sellerinfo_signup_itemname'] = 'Agency account registration at %s';
$_['ms_account_sellerinfo_saved'] = 'Agency account data saved.';
...
// Account - Vehicles
$_['ms_account_products_heading'] = 'Your Vehicles';
$_['ms_account_products_breadcrumbs'] = 'Your Vehicles';
$_['ms_account_products_image'] = 'Image';
$_['ms_account_products_product'] = 'Vehicle';
...
$_['ms_account_products_confirmdelete'] = 'Are you sure you want to delete your vehicle?';
...
// Account - Orders
$_['ms_account_orders_heading'] = 'Your Bookings';
$_['ms_account_orders_breadcrumbs'] = 'Your Bookings';
$_['ms_account_orders_id'] = 'Booking #';
$_['ms_account_orders_customer'] = 'Customer';
$_['ms_account_orders_products'] = 'Vehicles';
$_['ms_account_orders_total'] = 'Total amount';
$_['ms_account_orders_view'] = 'View booking';
$_['ms_account_orders_noorders'] = 'You don\'t have any bookings yet!';
$_['ms_account_orders_change_status']    = 'Change booking status';

$_['ms_account_order_information'] = 'Booking Information';

// Account - Dashboard
$_['ms_account_dashboard_heading'] = 'Agency Dashboard';
$_['ms_account_dashboard_breadcrumbs'] = 'Agency Dashboard';
$_['ms_account_dashboard_orders'] = 'Last bookings';
$_['ms_account_dashboard_overview'] = 'Overview';
$_['ms_account_dashboard_information'] = 'Information';
$_['ms_account_dashboard_seller_group'] = 'Agency group';
...
$_['ms_account_dashboard_total_sales'] = 'Total bookings';
$_['ms_account_dashboard_total_earnings'] = 'Total earnings';
$_['ms_account_dashboard_sales_month'] = 'Bookings this month';
...
$_['ms_account_dashboard_nav_product'] = 'Create a new vehicle';
$_['ms_account_dashboard_nav_products'] = 'Manage your vehicles';
...
$_['ms_account_stats_tab_by_product'] = 'By Vehicle';
...
$_['ms_account_stats_product'] = 'Vehicle';
...
$_['ms_catalog_product_sellerinfo'] = 'Agency information';
...
$_['ms_catalog_sellers_heading'] = 'Agencies';
...
$_['ms_catalog_sellers_totalproducts'] = 'Vehicles:';
...
$_['ms_catalog_sellers'] = 'Agencies';
$_['ms_catalog_sellers_empty'] = 'There are no agencies yet.';
...
$_['ms_catalog_seller_profile_about_seller'] = 'About the agency';
$_['ms_catalog_seller_profile_products'] = 'Some of agency\'s products';
$_['ms_catalog_seller_profile_tab_products'] = 'Vehicles';
