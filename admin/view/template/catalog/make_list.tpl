          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group"> 
                <!--<label class="control-label" for="input-name"><?php echo $entry_makes; ?></label>
                <input type="text" name="filter_name" value="<?php echo $filter_name; ?>" placeholder="<?php echo $entry_makes; ?>" id="input-name" class="form-control" />-->
                <label class="control-label" for="input-name"><?php echo $entry_makes; ?></label>
                <input type="text" name="filter_name" value="<?php echo $filter_name; ?>" placeholder="<?php echo $entry_makes; ?>" id="input-name" class="form-control" />
              ...
              <div class="form-group">
                <label class="control-label" for="input-model">
                  <?php if($filter_model=='1'){ ?>
                  <input type="checkbox" name="filter_model" checked="checked" id="make" value="1" />
                  <?php } else { ?>
                  <input type="checkbox" name="filter_model" id="make" value="1" />
                  <?php } ?>
                  &nbsp;&nbsp;<?php echo $entry_show_makes_only; ?></label>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=catalog/make&token=<?php echo $token; ?>';
	...
	var filter_model = $("#make").is(':checked') ? 1 : 0;
