...
<div id="help-modal" class="modal hide">
	...
	<div class="modal-body">
		...
		<h4>Installing Heatmap Tracker</h4>
		<iframe width="525" height="350" src="//www.youtube.com/embed/Lt4CvmgtLnM" frameborder="0" allowfullscreen></iframe>
	</div>
</div>
<a href="<?php echo $this->OPTIONS['brandsupport'] ?>/" target="_blank" class="btn btn-block btn-inverse pull-left" style="margin:0; width:100px; box-sizing: inherit;">Support</a>
<a href="#help-modal" data-toggle="modal" class="btn btn-block btn-inverse pull-left" style="margin-left: 10px; width:100px; box-sizing: inherit; margin-top: 0;">Help</a>
<br style="clear: both;"/>
<?php showErrors( $errors ); ?>
<form id="regform" class="form-vertical no-padding no-margin" method="post" action="" style="overflow: hidden; margin-top: 10px;">
	...
	<div style="width: <?php echo $reregister ? "350px" : "250px" ?>; float: left">
		...
		<div class="row">
			...
			<div class="text">
				<input id="license" name="license" value="<?php echo ( isset( $_POST["license"] ) ) ? $_POST["license"] : "" ?>" type="text"/>
			</div>
		</div>
		<div class="row">
	...
	<div style="width: 250px; float: left; margin-left: 20px;<?php echo $reregister ? "display:none;" : "" ?>">
		...
		<div id="mysql_server_config">
			<div class="row">
				...
				<div class="text">
					<input id="db_name" name="db_name" value="<?php echo ( isset( $_POST["db_name"] ) ) ? $_POST["db_name"] : "" ?>" type="text"/>
				</div>
			</div>
			<div class="row">
				...
				<div class="text">
					<input id="db_user" name="db_user" value="<?php echo ( isset( $_POST["db_user"] ) ) ? $_POST["db_user"] : "" ?>" type="text"/>
				</div>
			</div>
			<div class="row">
				...
				<div class="text">
					<input id="db_password" name="db_password" value="<?php echo ( isset( $_POST["db_password"] ) ) ? $_POST["db_password"] : "" ?>" type="text"/>
				</div>
			</div>
			<div class="row">
				...
				<div class="text">
					<input id="db_host" name="db_host" value="<?php echo ( isset( $_POST["db_host"] ) ) ? $_POST["db_host"] : "localhost" ?>" type="text"/>
				</div>
			</div>
			<div class="row">
				...
				<div class="text">
					<input id="db_host" name="db_port" value="<?php echo ( isset( $_POST["db_port"] ) ) ? $_POST["db_port"] : "3306" ?>" type="text"/>
				</div>
			</div>
			<div class="row">
				...
				<div class="text">
					<input id="db_prefix" name="db_prefix" value="<?php echo ( isset( $_POST["db_prefix"] ) ) ? $_POST["db_prefix"] : "hmt_" ?>" type="text"/>
				</div>
			</div>
		</div>
		...
		<div id="iam_config" style="display: none;">
			<div class="row">
				...
				<div class="text">
					<input id="iam_key" name="iam_key" value="<?php echo ( isset( $_POST["iam_key"] ) ) ? $_POST["iam_key"] : "" ?>" type="text"/>
				</div>
			</div>
			<div class="row">
				...
				<div class="text">
					<input id="iam_secret" name="iam_secret" value="<?php echo ( isset( $_POST["iam_secret"] ) ) ? $_POST["iam_secret"] : "" ?>" type="text"/>
				</div>
			</div>
			<div class="row">
...
<script>
	...
	function checkRds(elem) {
		if (elem.is(":checked")) {
			...
			prev_task = $("#fldTask").val();
			$("#fldTask").val("continue");
		} else {
