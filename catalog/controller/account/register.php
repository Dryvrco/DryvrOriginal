...
class ControllerAccountRegister extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_account_customer->addCustomer($this->request->post, $dup = '1');
            ...
            $this->response->redirect($this->url->link('account/register_success'));
        }
    ...
    public function validate() {
        ...
        if (utf8_strlen(trim($this->request->post['password'])) < 4) {
