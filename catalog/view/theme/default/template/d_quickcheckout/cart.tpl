    ...
    <table class="table table-bordered qc-cart">
      <thead>
        <tr>
          ...
          <td class="qc-quantity <?php echo (!$data['columns']['quantity'])?  'qc-hide' :""; ?>" style="display:none"><?php echo $column_quantity; ?>:</td>
          <td class="qc-price  <?php echo (!$data['columns']['price'] || $show_price)?  'qc-hide' :""; ?> ">Daily Rent:</td>
      ...
      <tbody>
        ...
        <tr <?php echo(!$product['stock']) ? 'class="stock"' : '' ;?>>
          ...
          <td class="qc-quantity  <?php echo (!$data['columns']['quantity'])?  'qc-hide' : '' ?> " style="display:none">
          ...
          <td class="qc-price <?php echo (!$data['columns']['price'] || $show_price)?  'qc-hide' : ''; ?> "><?php echo $product['daily']; ?></td>
