...
class ControllerAccountFavorites extends Controller {

    public function index() {
        if (!$this->customer->isLogged()) {
            $this->session->data['redirect'] = $this->url->link('account/favorites', '', 'SSL');
        ...
        if (isset($this->request->get['remove'])) {
            ...
            $this->response->redirect($this->url->link('account/favorites'));
        }
        ...
        foreach ($this->session->data['wishlist'] as $key => $product_id) {
            ...
            if ($product_info) {
                ...
                $data['products'][] = array(
                    ...
                    'agency' => $this->model_account_order->getSellerName($product_info['product_id']),
                    'thumb' => $image,
                    'name' => $this->model_catalog_product->getMakeModelCategories($product_info['product_id']),
                    'model' => $product_info['model'],
                    'stock' => $stock,
                    'price' => $price,
                    'special' => $special,
                    'href' => $this->url->link('product/product', 'product_id=' . $product_info['product_id']),
                    'remove' => $this->url->link('account/favorites', 'remove=' . $product_info['product_id'])
                );
            } else {
                unset($this->session->data['wishlist'][$key]);
            }
