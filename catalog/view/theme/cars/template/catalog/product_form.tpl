               ...
               <div class="panel-body">
                  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
                     <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab-unavail" data-toggle="tab"><?php echo $tab_unavail; ?></a></li>
                     </ul>
                     ...
                     <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                           ...
                           <div class="form-group required">
                              <label class="col-sm-2 control-label" for="input-model"><?php echo $entry_year; ?></label>
                              <div class="col-sm-10">
                           ...
                           <div class="form-group" style="display:none">
                              <label class="col-sm-2 control-label" for="input-country">Area</label>
                           ...
                           <div class="tab-content">
                              ...
                              <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                 ...
                                 <div class="form-group required" style="display:none">
                                    ...
                                    <div class="col-sm-10">
                                       <input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_title'] : $model; ?>" placeholder="<?php echo $entry_meta_title; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
                        ...
                        <div class="tab-pane" id="tab-data">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_daily; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="daily" value="<?php echo $daily; ?>" placeholder="<?php echo $entry_daily; ?>" id="input-price" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_weekly; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="weekly" value="<?php echo $weekly; ?>" placeholder="<?php echo $entry_weekly; ?>" id="input-price" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_weekend; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="weekend" value="<?php echo $weekend; ?>" placeholder="<?php echo $entry_weekend; ?>" id="input-price" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_monthly; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="monthly" value="<?php echo $monthly; ?>" placeholder="<?php echo $entry_monthly; ?>" id="input-price" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_tags; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="tags" value="<?php echo $tags; ?>" placeholder="<?php echo $entry_tags; ?>" id="input-price" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_mileage; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="mileage" value="<?php echo $mileage; ?>" placeholder="<?php echo $entry_mileage; ?>" id="input-price" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_over_miles; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="over_miles" value="<?php echo $over_miles; ?>" placeholder="<?php echo $entry_over_miles; ?>" id="input-price" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_delivery; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="delivery" value="<?php echo $delivery; ?>" placeholder="<?php echo $entry_delivery; ?>" id="input-price" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_airport; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="airport" value="<?php echo $airport; ?>" placeholder="<?php echo $entry_airport; ?>" id="input-price" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_after_hours; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="after_hours" value="<?php echo $after_hours; ?>" placeholder="<?php echo $entry_after_hours; ?>" id="input-price" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-insurance">Insurance Required</label>
                              <div class="col-sm-10">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_security; ?></label>
                              <div class="col-sm-10">
                                 <input type="text" name="security" value="<?php echo $security; ?>" placeholder="<?php echo $entry_security; ?>" id="input-price" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-price">Minimum Age</label>
                              <div class="col-sm-10">
                                 <input type="text" name="min_age" value="<?php echo $min_age; ?>" placeholder="Minimun Age" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group" style="display:none">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                 <select name="cat_id" class="form-control">
                                    ...
                                    <?php mkdd($secondcats,$cat_id); ?>
                                 </select>
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-category"><?php echo $entry_sub_category; ?></label>
                              <div class="col-sm-10" id="subcats">
                                 <select class="form-control fld" tabindex="2" name="subcat_id">
                                    <option value="">- Select 2nd Category -</option>
                                    <?php mkdd($secondcats,$subcat_id); ?>
                                 </select>
                              </div>
                           </div>
                           <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <?php } ?>
                        ...
                        <div class="tab-pane" id="tab-unavail">
                           <div class="table-responsive">
                              <table id="unavails" class="table table-striped table-bordered table-hover">
                                 <thead>
                                    <tr>
                                       <td class="text-left"><?php echo $entry_start_date; ?></td>
                                       <td class="text-left"><?php echo $entry_start_time; ?></td>
                                       <td class="text-left"><?php echo $entry_end_date; ?></td>
                                       <td class="text-left"><?php echo $entry_end_time; ?></td>
                                       <td></td>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    <?php $unavail_row = 0; ?>
                                    <?php foreach ($product_unavails as $product_unavail) { ?>
                                    <tr id="unavail-row<?php echo $unavail_row; ?>">
                                       <td class="text-left"><div class="input-group date">
                                             <input type="text" name="product_unavail[<?php echo $unavail_row; ?>][start_date]" value="<?php echo $product_unavail['start_date'] ?>" placeholder="<?php echo $entry_start_date; ?>" data-date-format="YYYY-MM-DD" class="form-control" />
                                             <span class="input-group-btn">
                                             <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                                             </span></div></td>
                                       <td class="text-left"><div class="input-group time">
                                             <input type="text" name="product_unavail[<?php echo $unavail_row; ?>][start_time]" value="<?php echo $product_unavail['start_time'] ?>" placeholder="<?php echo $entry_date_start; ?>" data-date-format="hh:mm A" class="form-control" />
                                             <span class="input-group-btn">
                                             <button type="button" class="btn btn-default"><i class="fa fa-clock-o"></i></button>
                                             </span></div></td>
                                       <td class="text-left"><div class="input-group date">
                                             <input type="text" name="product_unavail[<?php echo $unavail_row; ?>][end_date]" value="<?php echo $product_unavail['end_date'] ?>" placeholder="<?php echo $entry_end_date; ?>" data-date-format="YYYY-MM-DD" class="form-control" />
                                             <span class="input-group-btn">
                                             <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                                             </span></div></td>
                                       <td class="text-left"><div class="input-group time">
                                             <input type="text" name="product_unavail[<?php echo $unavail_row; ?>][end_time]" value="<?php echo $product_unavail['end_time'] ?>" placeholder="<?php echo $entry_date_start; ?>" data-date-format="hh:mm A" class="form-control" />
                                             <span class="input-group-btn">
                                             <button type="button" class="btn btn-default"><i class="fa fa-clock-o"></i></button>
                                             </span></div></td>
                                       <td class="text-left"><button type="button" onclick="$('#unavail-row<?php echo $unavail_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                                    </tr>
                                    <?php $unavail_row++; ?>
                                    <?php } ?>
                                 </tbody>
                                 <tfoot>
                                    <tr>
                                       <td colspan="4"></td>
                                       <td class="text-left"><button type="button" onclick="addUnavail();" data-toggle="tooltip" title="<?php echo $button_unavail_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                                    </tr>
                                 </tfoot>
                              </table>
                           </div>
                  ...
                  <div class="page-header">
                     <div class="container-fluid">
                        <div class="pull-right">
                           ...
                           <?php if ($del=='1'){ ?>
                           <a href="<?php echo $delete; ?>" data-toggle="tooltip" title="Delete" class="btn btn-danger" onclick="return confirm('are you sure?')"><i class="fa fa-trash"></i></a>
                           <?php } ?>
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
			...
			html += '        <td class="text-right" style="display:none"><?php echo $entry_quantity; ?></td>';
			html += '        <td class="text-left" style="display:none"><?php echo $entry_subtract; ?></td>';
			html += '        <td class="text-right"><?php echo $entry_price; ?></td>';
			html += '        <td class="text-right" style="display:none"><?php echo $entry_option_points; ?></td>';
			html += '        <td class="text-right" style="display:none"><?php echo $entry_weight; ?></td>';
			html += '        <td></td>';
			html += '      </tr>';
			html += '  	 </thead>';
			html += '  	 <tbody>';
...
function addOptionValue(option_row) {	
	...
	html += '  <td class="text-right" style="display:none"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][quantity]" value="" placeholder="<?php echo $entry_quantity; ?>" class="form-control" /></td>'; 
	html += '  <td class="text-left" style="display:none"><select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][subtract]" class="form-control">';
	html += '    <option value="1"><?php echo $text_yes; ?></option>';
	...
	html += '    <option value="-">-</option>';
	html += '  </select>';
	html += '  <input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][points]" value="" placeholder="<?php echo $entry_points; ?>" class="form-control" style="display:none" /></td>';	
	html += '  <td class="text-right" style="display:none"><select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][weight_prefix]" class="form-control">';
	html += '    <option value="+">+</option>';
	html += '    <option value="-">-</option>';
	html += '  </select>';
	html += '  <input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][weight]" value="" placeholder="<?php echo $entry_weight; ?>" class="form-control" style="display:none" /></td>';
...
//--></script> 
         <script type="text/javascript"><!--
var unavail_row = <?php echo $unavail_row; ?>;

function addUnavail() {
	html  = '<tr id="image-row' + unavail_row + '">';
	html += '  <td class="text-left"><div class="input-group date"><input type="text" name="product_unavail[' + unavail_row + '][start_date]" value="" placeholder="<?php echo $entry_start_date; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>';
	html += '  <td class="text-left"><div class="input-group time"><input type="text" name="product_unavail[' + unavail_row + '][start_time]" value="" placeholder="<?php echo $entry_date_start; ?>" data-date-format="hh:mm A" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-clock-o"></i></button></span></div></td>';
	html += '  <td class="text-left"><div class="input-group date"><input type="text" name="product_unavail[' + unavail_row + '][end_date]" value="" placeholder="<?php echo $entry_end_date; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>';
	html += '  <td class="text-left"><div class="input-group time"><input type="text" name="product_unavail[' + unavail_row + '][end_time]" value="" placeholder="<?php echo $entry_date_start; ?>" data-date-format="hh:mm A" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-clock-o"></i></button></span></div></td>';
	html += '  <td class="text-left"><button type="button" onclick="$(\'#image-row' + unavail_row  + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
	html += '</tr>';
	
	$('#unavails tbody').append(html);
...
/*$('select[name=\'country_id\']').on('change', function() {  
	$.ajax({
        ...
        success : function(data)  
      {
		  ...
		  $('#cities').html('<select class="form-control" name="city_id" id="city_id"><option value="">-- Select City --</option></select>');
		  $('#areas').html('<select class="form-control" name="area_id" id="area_id"><option value="">-- Select Area --</option></select>');
		  } 
	});
});
...
$(document).on("change", "#zone_id", function(){
	$.ajax({
        ...
        success : function(data)  
      {
		  $('#cities').html('<select class="form-control" name="city_id" id="city_id"><option value="">-- Select City --</option>' + data + '</select>');
	  $('#areas').html('<select class="form-control" name="area_id" id="area_id"><option value="">-- Select Area --</option></select>');
	  } 
	});
});
...
$(document).on("change", "#city_id", function(){
	$.ajax({
        ...
        dataType: 'html',
        success : function(data)  
      {$('#areas').html('<select class="form-control" name="area_id" id="area_id"><option value="">-- Select Area --</option>' + data + '</select>');} 
	});
});*/
