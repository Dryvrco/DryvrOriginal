...
class ModelSaleCustomer extends Model {
    ...
    public function addCustomer($data, $dup) {
        ...
        if ($dup == '1') {
            ...
            $this->db->query("UPDATE " . DB_PREFIX . "customer SET customer = '1' WHERE customer_id = '" . $customer_id . "'");
        }
    ...
    public function getTotalCustomers($data = array()) {
        $sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer WHERE customer = '1'";
