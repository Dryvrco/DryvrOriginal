...
class ControllerCatalogReview extends Controller {
    ...
    protected function getList() {
        ...
        foreach ($results as $result) {
            $data['reviews'][] = array(
                ...
                'product' => $this->model_catalog_product->getMakeModelCategoriesYear($result['product_id']),
                'name' => $result['name'],
    ...
    protected function getForm() {
        ...
        if (isset($this->request->post['product'])) {
            ...
            $data['product'] = $this->model_catalog_product->getMakeModelCategoriesYear($review_info['product_id']);
        } else {
            $data['product'] = '';
        }
