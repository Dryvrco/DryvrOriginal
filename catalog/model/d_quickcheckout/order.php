...
public function addOrder($data) {
	$this->db->query("INSERT INTO `" . DB_PREFIX . "order` SET 
		...
		date_added = NOW(), 
		date_modified = NOW(),
        start_date = '" . $this->session->data['start_date'] . "', start_time = '" . $this->session->data['start_time'] . "', end_date = '" . $this->session->data['end_date'] . "', end_time = '" . $this->session->data['end_time'] . "'");
