...
class ControllerCommonFileManager extends Controller {
    ...
    public function index() {
        ...
        foreach ($images as $image) {
            ...
            if (is_dir($image)) {
                ...
                $data['images'][] = array(
                    ...
                    'href' => $this->url->link('common/filemanager&directory=' . urlencode(utf8_substr($image, utf8_strlen(DIR_IMAGE . 'catalog/'))) . $url)
                );
        ...
        $data['parent'] = $this->url->link('common/filemanager' . $url);
        ...
        $data['refresh'] = $this->url->link('common/filemanager' . $url);
        ...
        $pagination->limit = 16;
        $pagination->url = $this->url->link('common/filemanager' . $url . '&page={page}');
