...
class ControllerUserUser extends Controller {
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('user/user' . $url, 'SSL'));
        }
    ...
    public function edit() {
        ...
        if ($this->model_user_user->checkUser($this->request->get['user_id'], $this->agency->getSellerId()) > 0) {
            $this->getForm();
        } else {
            $this->response->redirect($this->url->link('user/user'));
        }
    }
    ...
    public function delete() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            ...
            $this->response->redirect($this->url->link('user/user' . $url));
        }
    ...
    protected function getList() {
        ...
        foreach ($results as $result) {
            $data['users'][] = array(
                ...
                'edit' => $this->url->link('user/user/edit&user_id=' . $result['customer_id'] . $url)
            );
        }
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/user/user_list.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/user/user_list.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/catalog/user/user_list.tpl', $data));
        }
    }
    ...
    protected function getForm() {
        ...
        if (!isset($this->request->get['user_id'])) {
            ...
            $data['action'] = $this->url->link('user/user/edit&user_id=' . $this->request->get['user_id'] . $url);
        }
        ...
        if (isset($this->request->post['user_group_id'])) {
            ...
            $data['user_group_id'] = $user_info['customer_group_id'];
        } else {
            $data['user_group_id'] = '';
        }
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/user/user_form.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/user/user_form.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/user/user_form.tpl', $data));
        }
    }
