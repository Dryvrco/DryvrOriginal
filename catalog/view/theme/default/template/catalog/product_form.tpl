              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="cat_id" class="form-control">
                    ...
                    <?php foreach ($secondcats as $cats){ ?>
                    <?php if ($cats['category_id']==$cat_id)
                  {
                  	$selected = 'selected';
                  } else {
                  $selected = '';
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10" id="subcats">
                  <select class="form-control fld" tabindex="2" name="subcat_id">
                    <option value="0">- Select 2nd Category -</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <table id="unavails" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <td class="text-left"><?php echo $entry_unavail_start; ?></td>
                      <td class="text-left"><?php echo $entry_end_date; ?></td>
                      <td class="text-left"><?php echo $entry_unavail_end; ?></td>
                      <td></td>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr id="unavail-row<?php echo $unavail_row; ?>">
                      <td class="text-left"><div class="input-group date"><input type="text" name="product_unavail[<?php echo $unavail_row; ?>][start_date]" value="<?php echo $product_unavail['start_date'] ?>" placeholder="<?php echo $entry_start_date; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>
                      <td class="text-left"><div class="input-group time"><input type="text" name="product_unavail[<?php echo $unavail_row; ?>][start_time]" value="<?php echo $product_unavail['start_time'] ?>" placeholder="<?php echo $entry_date_start; ?>" data-date-format="hh:mm A" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-clock-o"></i></button></span></div></td>
                      <td class="text-left"><div class="input-group date"><input type="text" name="product_unavail[<?php echo $unavail_row; ?>][end_date]" value="<?php echo $product_unavail['end_date'] ?>" placeholder="<?php echo $entry_end_date; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>
                      <td class="text-left"><div class="input-group time"><input type="text" name="product_unavail[<?php echo $unavail_row; ?>][end_time]" value="<?php echo $product_unavail['end_time'] ?>" placeholder="<?php echo $entry_date_start; ?>" data-date-format="hh:mm A" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-clock-o"></i></button></span></div></td>
...
$('input[name=\'option\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/option/autocomplete&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
var subcat_id = <?php echo $subcat_id ?>;
  ...
  if (cat_id){
	  $.ajax({
		url: 'index.php?route=catalog/category/customautocomplete&token=<?php echo $token ?>&filter_cat=' + cat_id + '&filter_model=' + subcat_id,
		type: 'POST',
        dataType: 'html',
        success : function(data) 
      {$('#subcats').html('<select class="form-control fld" tabindex="2" name="subcat_id"><option value="0">- Select Model -</option>' + data + '</select>');}
	});
  }
  ...
  $('select[name=\'cat_id\']').on('change', function() {
	$.ajax({
        ...
        dataType: 'html',
        success : function(data) 
      {$('#subcats').html('<select class="form-control fld" tabindex="2" name="subcat_id"><option value="0">- Select 2nd Category -</option>' + data + '</select>');}
	});
});
//--></script> 
  <script type="text/javascript"><!--
